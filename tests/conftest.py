...
@pytest.fixture(scope="module")
def store(test_client, populate_db):
    """Create the database and the database table."""

    yield Store(db=db)  # this is where the testing happens!


@pytest.fixture(scope="module")
def api_store(test_client, populate_db):
    """Create the database and the database table."""

    yield APIStore(db=db)  # this is where the testing happens!
